...
# GRU for sentence distance learning
class GRUSent(nn.Module):
    ...
    # Constructor
    def __init__(self, window_size, vocab_size, hidden_dim, embedding_dim=50, out_channels=(20, 20, 20),
                 kernel_sizes=(3, 4, 5)):
        """
        Constructor
...
# Load model
def grusent(pretrained=False, lang='en', task='style-change-detection', **kwargs):
    """
    Load model
    :param pretrained:
    :param lang:
